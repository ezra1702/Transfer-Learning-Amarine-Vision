...
class OUV(Amarine):
    ...
    def status(self):
        return "OUV: Mode Hybrid"
    


def display_status(salmarine: Amarine):
    print(salmarine.menyelam())
    print(salmarine.bergerak())
    print(salmarine.status())
