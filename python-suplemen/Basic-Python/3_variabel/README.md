...
# Variabel
<img src="https://i.programmerhumor.io/2024/08/programmerhumor-io-programming-memes-2bfc29035ac3151.jpg">
</center>
...
Variabel merupakan sebuah referensi yang menunjuk ke suatu nilai (value) di dalam memori. Variabel sering dianalogikan sebagai wadah yang digunakan untuk menyimpan data.

Ketika ingin menyimpan sebuah data, cukup dengan memberikan nama pada variabel tersebut. Python kemudian akan secara otomatis mengalokasikan ruang penyimpanan yang sesuai dengan jenis data yang diberikan.

Dengan demikian, pengguna tidak perlu menentukan tipe atau ukuran memori secara manual, karena Python akan mengelolanya secara dinamis. Berikut merupakan contoh penggunaan variabel dalam Python:
...
Klik link ini untuk mencoba kode python dari pembahasan kali ini. [Source code](../03_variable/variabel.py)
